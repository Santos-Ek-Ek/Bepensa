...
<div class="wrapper">
  ...
  <aside class="main-sidebar sidebar-dark-primary elevation-4">
    ...
    <a href="#" class="brand-link" style="display: flex; justify-content: center; align-items: center;">
      ...
      <span class="brand-text font-weight-light"><img src="dist/img/logo.png" alt="AdminLTE Logo" style="opacity: .8"></span>
    </a>
    ...
    <div class="sidebar">
      ...
      <div class="user-panel mt-3 pb-3 mb-3 d-flex" style="align-items: justify; justify-content:justify; ">
        <div class="image" style="display: flex; align-items: center; justify-content: center; margin: 0.3rem;">
